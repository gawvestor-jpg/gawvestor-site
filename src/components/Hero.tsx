...
export function Hero() {
  return (
    <section id="home" className="bg-white px-5 pb-10 pt-10 text-center sm:pb-12 sm:pt-14">
      <div className="mx-auto max-w-sm sm:max-w-md">
        ...
        <h1 className="mt-5 font-display text-[2.6rem] font-medium leading-none tracking-tight text-navy-950 sm:text-5xl">
          {HERO.name}
        </h1>

...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-navy-950 px-6 py-16 sm:py-24 lg:py-section-y-lg text-center">
      ...
      <FadeIn className="relative z-10 mx-auto max-w-2xl">
        ...
        <p className="mt-3 font-sans text-sm font-medium uppercase tracking-wide text-gold-400 sm:text-base">
          {HERO.title}
        </p>

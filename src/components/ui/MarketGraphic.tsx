...
export function MarketGraphic({ className = '' }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <line x1="0" y1="180" x2="640" y2="180" className="stroke-white/[0.06]" strokeWidth="1" />
      <line x1="0" y1="120" x2="640" y2="120" className="stroke-white/[0.06]" strokeWidth="1" />
      <line x1="0" y1="60" x2="640" y2="60" className="stroke-white/[0.06]" strokeWidth="1" />
      ...
      {CANDLES.map((c) => (
        <g key={c.x}>
          ...
          <rect
            ...
            className={c.up ? 'fill-gold-400/[0.22]' : 'fill-teal-400/[0.18]'}
          />
        </g>
      ))}
